...
namespace Web.Controllers
{
	...
	public class ClothingManageController : Controller
	{
		...
		public IActionResult UnPaid()
		{
			...
			var clothings = _context.Clothings.Where(x => x.Paid == false && x.Status != (int)ClothingStatusEnum.Returned);
		...
		public IActionResult Index()
		{
			...
			var clothings = _context.Clothings.Where(x=> x.Status == (int)ClothingStatusEnum.Unwashed);
		...
		public IActionResult WashedButUnPick()
		{
			...
			var clothings = _context.Clothings.Where(x => x.Status == (int)ClothingStatusEnum.Washed && x.IsPickup == false);
		...
		public IActionResult PickedButUnPay()
		{
			...
			var clothings = _context.Clothings.Where(x => x.Paid == false && x.IsPickup && x.Status != (int)ClothingStatusEnum.Returned);
